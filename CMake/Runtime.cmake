...
source_group(TREE ${SCENE_INTERFACE_DIR} PREFIX "Header Files" FILES ${SCENE_INTERFACE_FILES})
source_group(TREE ${SCENE_SOURCE_DIR} PREFIX "Source Files\\Scene" FILES ${SCENE_INCLUDE_FILES} ${SCENE_SOURCE_FILES})
...
set(RUNTIME_INCLUDE_DIR
    ...
    ${ENGINE_RUNTIME_SOURCE_DIR}/Scene/Public
...
target_link_libraries(${ENGINE_RUNTIME} PRIVATE HorizonFlecs)
