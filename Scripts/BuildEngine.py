...
build_dir = os.path.join(engine_path, "build")
...
vs_gen_cmd = ["cmake", "-G", "Visual Studio 17 2022", "-DCMAKE_INCLUDE_SHADERS=false", "-B", msvc_build_dir, "-S", engine_path]
...
ninja_gen_cmd = ["cmake", "-G", "Ninja", "-DCMAKE_C_COMPILER=clang", "-DCMAKE_CXX_COMPILER=clang++", "-DCMAKE_INCLUDE_SHADERS=false", "-DCMAKE_BUILD_TYPE=Debug", "-B", clang_build_dir, "-S", engine_path]
