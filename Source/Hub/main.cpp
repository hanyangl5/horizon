...
#endif
{
    ...
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Horizon Hub", WS_OVERLAPPEDWINDOW, 100, 100, 1024, 600, nullptr,
    ...
    io.Fonts->AddFontFromFileTTF("C:/Windows/Fonts/segoeui.ttf", 20.0f * ImGui_ImplWin32_GetDpiScaleForHwnd(hwnd), &config);
    io.Fonts->Build();
    ...
    clear_color = ImVec4(0.12f, 0.12f, 0.12f, 1.00f);
    // Main loop
    bool done = false;
    while (!done)
    {
