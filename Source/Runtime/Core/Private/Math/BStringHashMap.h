...
#define bhgeti_unsafe_impl(t, k, f, l, fn, p)                                                                                \
    ((t) == NULL ? -1                                                                                                        \
                 : (stbds_hmget_key_wrapper((t), sizeof *(t), STBDS_ALIGNOF_PTR((t)), (void*)STBDS_ADDRESSOF((t)->key, (k)), \
                                            sizeof(t)->key, STBDS_HM_CONST_BSTRING STBDS_IF_MEM_TRACKING(, f, l, fn, p)),    \
                    stbds_temp((t)-1)))
...
#define bhgeti_impl(t, k, f, l, fn, p)                                                                                              \
    ((t) = stbds_hmget_key_wrapper((t), sizeof *(t), STBDS_ALIGNOF_PTR((t)), (void*)STBDS_ADDRESSOF((t)->key, (k)), sizeof(t)->key, \
                                   STBDS_HM_CONST_BSTRING STBDS_IF_MEM_TRACKING(, f, l, fn, p)),                                    \
     stbds_temp((t)-1))
...
#define bhgetp_impl(t, k, f, l, fn, p) ((void)bhgeti_impl(t, k, f, l, fn, p), &(t)[stbds_temp((t)-1)])
#define bhgetp(t, k)                   bhgetp_impl(t, k, __FILE__, __LINE__, __FUNCTION__, "bhgetp")

#define bhgetp_null(t, k)              (bhgeti_unsafe_impl(t, k, __FILE__, __LINE__, __FUNCTION__, "bhgetp_null") == -1 ? NULL : &(t)[stbds_temp((t)-1)])
