...
const char g_ProfileHtml_begin_0[] =
    ...
    ".help {position:fixed;z-index:5;text-align:left;padding:2px;margin-left:-999em;background-color: #313131;width:300px;}\n"
    ".helpstart {position:fixed;z-index:5;text-align:left;padding:2px;background-color: #313131;width:300px;display:block}\n"
    ...
    "</div>\n"
    "<canvas id=\"History\" height=\"70\" style=\"background-color:#474747;margin:0px;padding:0px;\"></canvas><canvas id=\"DetailedView\" "
    "height=\"200\" style=\"background-color:#474747;margin:0px;padding:0px;\"></canvas>\n"
    "<div id=\"root\" class=\"root\">\n"
    "<ul id=\"nav\">\n"
    "<li><a href=\"javascript:void(0)\" onclick=\"ToggleDebugMode();\">?</a>\n"
    "<div class=\"helpstart\" id=\"helpwindow\" style=\"left:20px;bottom:20px\">\n"
    "History View:<br>\n"
    ...
    "</table>\n"
    "</div>\n"
    "<div class=\"help\" id=\"divFrameInfo\" style=\"left:20px;top:20px;width:auto;\">\n"
    "</div>\n"
    "</li>\n"
    ...
    "{\n"
    "	var group = {\"id\":id, \"name\":name, \"category\":category, \"numtimers\":numtimers, \"isgpu\":isgpu, \"total\": total, "
    "\"average\" : average, \"max\" : max, \"color\":color};\n"
    "	return group;\n"
    "}\n"
    "\n"
    "function MakeTimer(id, name, group, color, colordark, average, max, min, exclaverage, exclmax, callaverage, callcount, total, meta, "
    "metaagg, metamax)\n"
    "{\n"
    "	var timer = {\"id\":id, \"name\":name, \"namelabel\":name.startsWith(\"$\"), \"color\":color, "
    "\"colordark\":colordark,\"timercolor\":color, \"textcolor\":InvertColor(color), \"group\":group, \"average\":average, \"max\":max, "
    "\"min\":min, \"exclaverage\":exclaverage, \"exclmax\":exclmax, \"callaverage\":callaverage, \"callcount\":callcount, \"total\":total, "
    "\"meta\":meta, \"textcolorindex\":InvertColorIndex(color), \"metaagg\":metaagg, \"metamax\":metamax, \"worst\":0, \"worststart\":0, "
    "\"worstend\":0};\n"
    "	return timer;\n"
    "}\n"
    "\n"
    ...
    "{\n"
    "	var frame = {\"id\":id, \"framestart\":framestart, \"frameend\":frameend, \"framestartgpu\":framestartgpu, "
    "\"frameendgpu\":frameendgpu, \"ts\":ts, \"tt\":tt, \"ti\":ti, \"tl\":tl};\n"
    "	return frame;\n"
    "}\n"
    "\n"
    "function MakeCounter(id, parent, sibling, firstchild, level, name, value, minvalue, maxvalue, formatted, limit, formattedlimit, "
    "format, counterprc, boxprc, historydata)\n"
    "{\n"
    ...
    "	}\n"
    "\n"
    "	var counter = { \"id\":id, \"parent\":parent, \"sibling\":sibling, \"firstchild\":firstchild, \"level\": level, \"name\":name, "
    "\"value\":value, \"formatted\":formatted, \"limit\":limit, \"formattedlimit\":formattedlimit, \"format\":format, "
    "\"counterprc\":counterprc, \"boxprc\":boxprc, \"historyprc\": historyprc, \"historydata\":historydata, \"minvalue\":minvalue, "
    "\"maxvalue\":maxvalue};\n"
    "	return counter;\n"
    "}\n"
    "\n"
...
const char g_ProfileHtml_end_0[] =
    ...
    "var CSwitchColors =[\"#9DD8AF\",\"#D7B6DA\",\"#EAAC76\",\"#DBDA61\",\"#8AD5E1\",\"#8CE48B\",\"#C4D688\",\"#57E5C4\"];//generated by "
    ...
    "	txt = txt + \'<hr>\';\n"
    "	txt = txt + \'Gpu: \' + GpuName+ \'<br>\';\n"
    "	txt = txt + \'Vendor ID: \' + VendorID + \'<br>\';\n"
    "	txt = txt + \'Model ID: \' + ModelID + \'<br>\';\n"
    "	div.innerHTML = txt;\n"
    "}\n"
    "function InitGroups()\n"
    "{\n"
...
const char   g_ProfileHtml_end_1[] =
    ...
    "	{\n"
    "		var bMouseIn = DetailedViewMouseY >= 0 && DetailedViewMouseY < BoxHeight && DetailedViewMouseX < X && DetailedViewMouseX > "
    "XBegin;\n"
    "		if(bMouseIn)\n"
    "		{\n"
    ...
    "FilterMatch(FilterGroup, Group.name))\n"
    "					{\n"
    ...
    "&& FilterMatch(FilterTimer, ThreadNames[i]))\n"
    "						{\n"
    "							var YText = Y+Height-FontAscent;\n"
    "							bMouseIn = DetailedViewMouseY >= Y && DetailedViewMouseY < Y + BoxHeight;\n"
    "							nColorIndex = 1-nColorIndex;\n"
    ...
    "	if(CounterNameWidthNew != CounterNameWidth || CounterValueWidthNew != CounterValueWidth || CounterLimitWidthNew != "
    "CounterLimitWidth)\n"
    "	{\n"
    ...
    "				}\n"
    "				if(DetailedViewMouseX >= X && DetailedViewMouseX <= X+W && DetailedViewMouseY < fOffsetY+CSwitchHeight && "
    "DetailedViewMouseY >= fOffsetY)\n"
    "				{\n"
    ...
    "				{\n"
    "					DrawContextSwitchBars(context, ThreadIds[nLog], fScaleX, fOffsetY, fDetailedOffset, nHoverColor, MinWidth, "
    "bDrawEnabled);\n"
...
const char   g_ProfileHtml_end_2[] =
    ...
    "								}\n"
    "\n"
    "								if(DetailedViewMouseX >= X && DetailedViewMouseX <= X+W && DetailedViewMouseY < Y+BoxHeight && "
    ...
    "	var fOffsetY = -nOffsetY + BoxHeight;\n"
    "\n"
    "	if(DetailedRedrawState.fOffsetY == fOffsetY && DetailedRedrawState.fDetailedOffset == fDetailedOffset && "
    "DetailedRedrawState.fDetailedRange == fDetailedRange && !KeyCtrlDown && !KeyShiftDown && !MouseDragButton)\n"
    "	{\n"
    "		Invalidate++;\n"
    "	}\n"
    "	else\n"
    ...
    "	{\n"
    "		if(ProfileMode == 2 || ((nHoverCSCpu >= 0 || nHoverToken != -1) && !KeyCtrlDown && !KeyShiftDown && "
    "!MouseDragButton)||(Invalidate<2 && !KeyCtrlDown && !KeyShiftDown && !MouseDragButton))\n"
    "		{\n"
    "			RedrawMode = 1;\n"
    "		}\n"
    "	}\n"
    ...
    "				MoveTo(RangeSelect.Begin, RangeSelect.End, ThreadY[RangeSelect.Thread] + nOffsetY, ThreadY[RangeSelect.Thread+1] + "
    "nOffsetY);\n"
    "				MouseHandleDragEnd();\n"
    "			}\n"
    "		}\n"
...
const char   g_ProfileHtml_end_3[] = "e mousewheel as of FF3.x\n"
                                   "\n"
                                   ...
                                   "			var FrameDiscard = (ThreadGpu[nLog] ? Frame_.frameendgpu : Frame_.frameend) + 33;//if "
