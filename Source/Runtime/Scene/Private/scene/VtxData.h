...
constexpr const uint32_t kMeshFileMagic = 0x1234567b;
...
struct MeshFileHeader
{
    ...
    uint32_t magicValue = kMeshFileMagic;
...
struct MeshData
{
    ...
    MeshFileHeader getMeshFileHeader() const
    {
        return {
            ...
            .positionDataSize = (uint32_t)positionData.size(),
            .attributeDataSize = (uint32_t)attributeData.size(),
        };
    }
};
