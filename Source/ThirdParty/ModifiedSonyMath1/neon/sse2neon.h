...
FORCE_INLINE __m128 _mm_loadl_pi(__m128 a, __m64* p)
{
...
FORCE_INLINE __m128 _mm_loadl_epi64(__m128i const *p) {
...
FORCE_INLINE __m128 _mm_loadh_pi(__m128 a, __m64* p)
{
...
// Xn+1 = Xn * (3 - IN * Xn2)/2
FORCE_INLINE __m128 rsqrtq_newton(__m128 in, int n)
{
	int i;
...
FORCE_INLINE __m128 _mm_dp_ps(__m128 a, __m128 b, const int mask) {
