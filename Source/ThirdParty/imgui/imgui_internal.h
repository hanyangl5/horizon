...
// Helpers: File System
#ifdef FORGE_UI_IMGUI_FORCE_FILE_SYSTEM
#define IMGUI_DISABLE_TTY_FUNCTIONS
typedef FileStream          ImFileHandle;
IMGUI_API bool              ImFileOpen(const char* filename, FileMode mode, ImFileHandle* file);
...
#endif
#ifdef FORGE_UI_IMGUI_FORCE_FILE_SYSTEM
IMGUI_API void*             ImFileLoadToMemory(const char* filename, FileMode mode, size_t* out_file_size, int padding_bytes = 0);
#else
