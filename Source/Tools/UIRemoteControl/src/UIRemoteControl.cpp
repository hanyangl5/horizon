...
//                 rtDesc.mStartState = RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE | RESOURCE_STATE_PIXEL_SHADER_RESOURCE;
...
//             if (gRemoteRenderTarget.pRenderTarget)
//             {
//                 barriers[0] = { gRemoteRenderTarget.pRenderTarget, RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE | RESOURCE_STATE_PIXEL_SHADER_RESOURCE, RESOURCE_STATE_RENDER_TARGET };
//                 cmdResourceBarrier(cmd, 0, NULL, 0, NULL, 1, barriers);
...
//                 barriers[0] = { gRemoteRenderTarget.pRenderTarget, RESOURCE_STATE_RENDER_TARGET, RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE | RESOURCE_STATE_PIXEL_SHADER_RESOURCE };
//                 cmdResourceBarrier(cmd, 0, NULL, 0, NULL, 1, barriers);
//             }
//         }
