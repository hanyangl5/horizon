...
// 2023-08-11 10:44:49.868241
// "C:\hanyanglu\horizon\assets\shaders\gbuffer_bindless.vert.hsl"
//--------------------------------------
...
#line 1 "C:/hanyanglu/horizon/assets/shaders/gbuffer_bindless.vert.hsl"
...
#line 2 "C:/hanyanglu/horizon/assets/C:/hanyanglu/horizon/assets/shaders/gbuffer_bindless.vert.hsl"
#ifdef VULKAN
#extension GL_EXT_nonuniform_qualifier : enable // how to hide this?
//#extension GL_ARB_shader_draw_parameters : enable
#endif

#line 6 "C:/hanyanglu/horizon/assets/C:/hanyanglu/horizon/assets/shaders/gbuffer_bindless.vert.hsl"
...
#define _Getprev_vp prev_vp
#line 10
    DATA(float4x4, prev_vp, None);
#define _Getcamera_position camera_position
#line 11
    DATA(float4, camera_position, None);
};

PUSH_CONSTANT(DrawRootConstant, b1){
#define _Getmesh_id_offset DrawRootConstant.mesh_id_offset
#line 15
...
#define _Getinstance_parameter instance_parameter
layout (std430, UPDATE_FREQ_PER_FRAME, binding = 1) readonly buffer instance_parameter
{
	InstanceParameter instance_parameter_data[];
};
#define instance_parameter instance_parameter_data

STRUCT(VSInput)
{
#define _position_977
#line 29
...
#endif
#ifdef _normal_982
layout(location = 1) in(float3) NORMAL;
#endif
#ifdef _uv0_987
layout(location = 2) in(float2) UV0;
#endif
#ifdef _uv1_992
layout(location = 3) in(float2) UV1;
#endif
#ifdef _tangent_997
...
STRUCT(VSOutput)
{
#define _position_1031
#line 47
	DATA(float4, position, SV_Position);
#define _world_pos_1036
#line 48
...
#define _tangent_1051
#line 51
	DATA(float3, tangent, TANGENT);
#define _instance_id_1056
#line 52
    uint instance_id;
#ifdef VULKAN
#define _material_id_1062
#line 54
    uint material_id;
#endif

#line 56 "C:/hanyanglu/horizon/assets/C:/hanyanglu/horizon/assets/shaders/gbuffer_bindless.vert.hsl"
#define _curr_pos_1070
#line 56
    DATA(float4, curr_pos, None);
#define _prev_pos_1075
#line 57
    DATA(float4, prev_pos, None);
};
#ifdef _world_pos_1036
layout(location = 0) out(float3) out_VSOutput_world_pos;
#endif
#ifdef _normal_1041
layout(location = 1) out(float3) out_VSOutput_normal;
#endif
#ifdef _uv_1046
layout(location = 2) out(float2) out_VSOutput_uv;
#endif
#ifdef _tangent_1051
layout(location = 3) out(float3) out_VSOutput_tangent;
#endif
#ifdef _instance_id_1056
layout(location = 4) flat out(uint) out_VSOutput_instance_id;
#endif
#ifdef _material_id_1062
layout(location = 5) flat out(uint) out_VSOutput_material_id;
#endif
#ifdef _curr_pos_1070
layout(location = 6) out(float4) out_VSOutput_curr_pos;
#endif
#ifdef _prev_pos_1075
layout(location = 7) out(float4) out_VSOutput_prev_pos;
#endif
#line 59
...
#endif
#ifdef _tangent_997
	vsin.tangent = TANGENT;
	TANGENT;
#endif
	const uint InstanceID = uint(SV_INSTANCEID);
	const uint vertex_id = uint(SV_VERTEXID);
#line 62
//    INIT_MAIN;
    VSOutput vsout;
    uint mesh_id;
...
#line 68 "C:/hanyanglu/horizon/assets/C:/hanyanglu/horizon/assets/shaders/gbuffer_bindless.vert.hsl"
    ...
    {
    	VSOutput out_VSOutput = vsout;
#ifdef _position_1031
    	gl_Position = out_VSOutput.position;
#endif
#ifdef _world_pos_1036
    	out_VSOutput_world_pos = out_VSOutput.world_pos;
#endif
#ifdef _normal_1041
    	out_VSOutput_normal = out_VSOutput.normal;
#endif
#ifdef _uv_1046
    	out_VSOutput_uv = out_VSOutput.uv;
#endif
#ifdef _tangent_1051
    	out_VSOutput_tangent = out_VSOutput.tangent;
#endif
#ifdef _instance_id_1056
    	out_VSOutput_instance_id = out_VSOutput.instance_id;
#endif
#ifdef _material_id_1062
    	out_VSOutput_material_id = out_VSOutput.material_id;
#endif
#ifdef _curr_pos_1070
    	out_VSOutput_curr_pos = out_VSOutput.curr_pos;
#endif
#ifdef _prev_pos_1075
    	out_VSOutput_prev_pos = out_VSOutput.prev_pos;
#endif
    	return;
    }
#line 88
