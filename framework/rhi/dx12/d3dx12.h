...
struct CD3DX12_DEPTH_STENCIL_DESC2 : public D3D12_DEPTH_STENCIL_DESC2
{
    ...
    explicit CD3DX12_DEPTH_STENCIL_DESC2(const D3D12_DEPTH_STENCIL_DESC2 &o) noexcept : D3D12_DEPTH_STENCIL_DESC2(o)
    {
    }
    ...
    explicit CD3DX12_DEPTH_STENCIL_DESC2(CD3DX12_DEFAULT) noexcept
    {
        ...
        const D3D12_DEPTH_STENCILOP_DESC1 defaultStencilOp = {
            ...
            D3D12_COMPARISON_FUNC_ALWAYS, D3D12_DEFAULT_STENCIL_READ_MASK, D3D12_DEFAULT_STENCIL_WRITE_MASK};
        FrontFace = defaultStencilOp;
        BackFace = defaultStencilOp;
        DepthBoundsTestEnable = FALSE;
    }
    explicit CD3DX12_DEPTH_STENCIL_DESC2(BOOL depthEnable, D3D12_DEPTH_WRITE_MASK depthWriteMask,
                                         ...
                                         UINT8 frontStencilReadMask, UINT8 frontStencilWriteMask,
                                         D3D12_STENCIL_OP backStencilFailOp, D3D12_STENCIL_OP backStencilDepthFailOp,
                                         D3D12_STENCIL_OP backStencilPassOp, D3D12_COMPARISON_FUNC backStencilFunc,
                                         UINT8 backStencilReadMask, UINT8 backStencilWriteMask,
...
struct CD3DX12_RASTERIZER_DESC1 : public D3D12_RASTERIZER_DESC1
{
    ...
    explicit CD3DX12_RASTERIZER_DESC1(const D3D12_RASTERIZER_DESC1 &o) noexcept : D3D12_RASTERIZER_DESC1(o)
    ...
    explicit CD3DX12_RASTERIZER_DESC1(D3D12_FILL_MODE fillMode, D3D12_CULL_MODE cullMode, BOOL frontCounterClockwise,
...
struct CD3DX12_RASTERIZER_DESC2 : public D3D12_RASTERIZER_DESC2
{
    ...
    explicit CD3DX12_RASTERIZER_DESC2(const D3D12_RASTERIZER_DESC2 &o) noexcept : D3D12_RASTERIZER_DESC2(o)
    ...
    explicit CD3DX12_RASTERIZER_DESC2(D3D12_FILL_MODE fillMode, D3D12_CULL_MODE cullMode, BOOL frontCounterClockwise,
                                      FLOAT depthBias, FLOAT depthBiasClamp, FLOAT slopeScaledDepthBias,
                                      BOOL depthClipEnable, D3D12_LINE_RASTERIZATION_MODE lineRasterizationMode,
                                      UINT forcedSampleCount,
                                      D3D12_CONSERVATIVE_RASTERIZATION_MODE conservativeRaster) noexcept
    {
        FillMode = fillMode;
...
struct CD3DX12_STATIC_SAMPLER_DESC1 : public D3D12_STATIC_SAMPLER_DESC1
{
    ...
    explicit CD3DX12_STATIC_SAMPLER_DESC1(const D3D12_STATIC_SAMPLER_DESC1 &o) noexcept : D3D12_STATIC_SAMPLER_DESC1(o)
    {
    }
    CD3DX12_STATIC_SAMPLER_DESC1(UINT shaderRegister, D3D12_FILTER filter = D3D12_FILTER_ANISOTROPIC,
                                 ...
                                 D3D12_SHADER_VISIBILITY shaderVisibility = D3D12_SHADER_VISIBILITY_ALL,
                                 UINT registerSpace = 0,
                                 D3D12_SAMPLER_FLAGS flags = D3D12_SAMPLER_FLAGS::D3D12_SAMPLER_FLAG_NONE)
    noexcept
    {
        Init(shaderRegister, filter, addressU, addressV, addressW, mipLODBias, maxAnisotropy, comparisonFunc,
             borderColor, minLOD, maxLOD, shaderVisibility, registerSpace, flags);
    }
...
struct CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC : public D3D12_VERSIONED_ROOT_SIGNATURE_DESC
{
    ...
    static inline void Init_1_2(_Out_ D3D12_VERSIONED_ROOT_SIGNATURE_DESC &desc, UINT numParameters,
                                ...
                                UINT numStaticSamplers = 0,
                                _In_reads_opt_(numStaticSamplers)
                                    const D3D12_STATIC_SAMPLER_DESC1 *_pStaticSamplers = nullptr,
                                D3D12_ROOT_SIGNATURE_FLAGS flags = D3D12_ROOT_SIGNATURE_FLAG_NONE) noexcept
    {
                                 ...
                                 _In_reads_(NumSubresources) const D3D12_SUBRESOURCE_DATA *pSrcData) noexcept
{
    ...
    const UINT64 Result =
        UpdateSubresources(pCmdList, pDestinationResource, pIntermediate, FirstSubresource, NumSubresources,
                                                         ...
                                                         ID3DBlob **ppErrorBlob) noexcept
{
    ...
    case D3D_ROOT_SIGNATURE_VERSION_1_0:
...
#endif
        {
            ...
            if (SUCCEEDED(hr))
            {
                const CD3DX12_ROOT_SIGNATURE_DESC desc_1_0(desc_1_1.NumParameters, pParameters_1_0,
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 606)
typedef CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<CD3DX12_DEPTH_STENCIL_DESC2,
                                                D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_DEPTH_STENCIL2, CD3DX12_DEFAULT>
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 608)
typedef CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<CD3DX12_RASTERIZER_DESC1,
                                                D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_RASTERIZER1, CD3DX12_DEFAULT>
    CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER1;
#endif
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 610)
typedef CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT<CD3DX12_RASTERIZER_DESC2,
                                                D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_RASTERIZER2, CD3DX12_DEFAULT>
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 610)
// Use CD3DX12_PIPELINE_STATE_STREAM5 for D3D12_RASTERIZER_DESC2 when CheckFeatureSupport returns true for
// Options19::RasterizerDesc2Supported is true Use CD3DX12_PIPELINE_STATE_STREAM4 for D3D12_RASTERIZER_DESC1 when
// CheckFeatureSupport returns true for Options16::DynamicDepthBiasSupported is true Use CD3DX12_PIPELINE_STATE_STREAM3
// for D3D12_DEPTH_STENCIL_DESC2 when CheckFeatureSupport returns true for
// Options14::IndependentFrontAndBackStencilSupported is true Use CD3DX12_PIPELINE_STATE_STREAM2 for OS Build 19041+
// (where there is a new mesh shader pipeline). Use CD3DX12_PIPELINE_STATE_STREAM1 for OS Build 16299+ (where there is a
// new view instancing subobject). Use CD3DX12_PIPELINE_STATE_STREAM for OS Build 15063+ support.
struct CD3DX12_PIPELINE_STATE_STREAM5
{
    ...
    CD3DX12_PIPELINE_STATE_STREAM5(const D3D12_GRAPHICS_PIPELINE_STATE_DESC &Desc)
    noexcept
        : Flags(Desc.Flags), NodeMask(Desc.NodeMask), pRootSignature(Desc.pRootSignature),
          ...
          DepthStencilState(CD3DX12_DEPTH_STENCIL_DESC2(Desc.DepthStencilState)), DSVFormat(Desc.DSVFormat),
    ...
    CD3DX12_PIPELINE_STATE_STREAM5(const D3DX12_MESH_SHADER_PIPELINE_STATE_DESC &Desc)
    noexcept
        : Flags(Desc.Flags), NodeMask(Desc.NodeMask), pRootSignature(Desc.pRootSignature),
    ...
    CD3DX12_PIPELINE_STATE_STREAM5(const D3D12_COMPUTE_PIPELINE_STATE_DESC &Desc)
    noexcept
        : Flags(Desc.Flags), NodeMask(Desc.NodeMask), pRootSignature(Desc.pRootSignature),
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 608)
// Use CD3DX12_PIPELINE_STATE_STREAM4 for D3D12_RASTERIZER_DESC1 when CheckFeatureSupport returns true for
// Options16::DynamicDepthBiasSupported is true Use CD3DX12_PIPELINE_STATE_STREAM3 for D3D12_DEPTH_STENCIL_DESC2 when
// CheckFeatureSupport returns true for Options14::IndependentFrontAndBackStencilSupported is true Use
// CD3DX12_PIPELINE_STATE_STREAM2 for OS Build 19041+ (where there is a new mesh shader pipeline). Use
// CD3DX12_PIPELINE_STATE_STREAM1 for OS Build 16299+ (where there is a new view instancing subobject). Use
...
struct CD3DX12_PIPELINE_STATE_STREAM4
{
    ...
    // Mesh and amplification shaders must be set manually, since they do not have representation in
    // D3D12_GRAPHICS_PIPELINE_STATE_DESC
    CD3DX12_PIPELINE_STATE_STREAM4(const D3D12_GRAPHICS_PIPELINE_STATE_DESC &Desc)
    noexcept
        : Flags(Desc.Flags), NodeMask(Desc.NodeMask), pRootSignature(Desc.pRootSignature),
          InputLayout(Desc.InputLayout), IBStripCutValue(Desc.IBStripCutValue),
          PrimitiveTopologyType(Desc.PrimitiveTopologyType), VS(Desc.VS), GS(Desc.GS), StreamOutput(Desc.StreamOutput),
    ...
    CD3DX12_PIPELINE_STATE_STREAM4(const D3DX12_MESH_SHADER_PIPELINE_STATE_DESC &Desc)
    noexcept
        : Flags(Desc.Flags), NodeMask(Desc.NodeMask), pRootSignature(Desc.pRootSignature),
          PrimitiveTopologyType(Desc.PrimitiveTopologyType), PS(Desc.PS), AS(Desc.AS), MS(Desc.MS),
          BlendState(CD3DX12_BLEND_DESC(Desc.BlendState)),
    ...
    CD3DX12_PIPELINE_STATE_STREAM4(const D3D12_COMPUTE_PIPELINE_STATE_DESC &Desc)
    noexcept
        : Flags(Desc.Flags), NodeMask(Desc.NodeMask), pRootSignature(Desc.pRootSignature),
          CS(CD3DX12_SHADER_BYTECODE(Desc.CS)), CachedPSO(Desc.CachedPSO)
    {
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 606)
// Use CD3DX12_PIPELINE_STATE_STREAM3 for D3D12_DEPTH_STENCIL_DESC2 when CheckFeatureSupport returns true for
// Options14::IndependentFrontAndBackStencilSupported is true Use CD3DX12_PIPELINE_STATE_STREAM2 for OS Build 19041+
// (where there is a new mesh shader pipeline). Use CD3DX12_PIPELINE_STATE_STREAM1 for OS Build 16299+ (where there is a
// new view instancing subobject). Use CD3DX12_PIPELINE_STATE_STREAM for OS Build 15063+ support.
struct CD3DX12_PIPELINE_STATE_STREAM3
{
    ...
    // Mesh and amplification shaders must be set manually, since they do not have representation in
    // D3D12_GRAPHICS_PIPELINE_STATE_DESC
    CD3DX12_PIPELINE_STATE_STREAM3(const D3D12_GRAPHICS_PIPELINE_STATE_DESC &Desc)
    noexcept
        : Flags(Desc.Flags), NodeMask(Desc.NodeMask), pRootSignature(Desc.pRootSignature),
          InputLayout(Desc.InputLayout), IBStripCutValue(Desc.IBStripCutValue),
          PrimitiveTopologyType(Desc.PrimitiveTopologyType), VS(Desc.VS), GS(Desc.GS), StreamOutput(Desc.StreamOutput),
    ...
    CD3DX12_PIPELINE_STATE_STREAM3(const D3DX12_MESH_SHADER_PIPELINE_STATE_DESC &Desc)
    noexcept
        : Flags(Desc.Flags), NodeMask(Desc.NodeMask), pRootSignature(Desc.pRootSignature),
          PrimitiveTopologyType(Desc.PrimitiveTopologyType), PS(Desc.PS), AS(Desc.AS), MS(Desc.MS),
          BlendState(CD3DX12_BLEND_DESC(Desc.BlendState)),
    ...
    CD3DX12_PIPELINE_STATE_STREAM3(const D3D12_COMPUTE_PIPELINE_STATE_DESC &Desc)
    noexcept
        : Flags(Desc.Flags), NodeMask(Desc.NodeMask), pRootSignature(Desc.pRootSignature),
          CS(CD3DX12_SHADER_BYTECODE(Desc.CS)), CachedPSO(Desc.CachedPSO)
    {
...
struct CD3DX12_PIPELINE_STATE_STREAM3_PARSE_HELPER : public ID3DX12PipelineParserCallbacks
{
    ...
    CD3DX12_PIPELINE_STATE_STREAM3_PARSE_HELPER() noexcept : SeenDSS(false)
    {
        // Adjust defaults to account for absent members.
        PipelineStream.PrimitiveTopologyType = D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE;
...
struct CD3DX12_PIPELINE_STATE_STREAM4_PARSE_HELPER : public ID3DX12PipelineParserCallbacks
{
    ...
    CD3DX12_PIPELINE_STATE_STREAM4_PARSE_HELPER() noexcept : SeenDSS(false)
    {
        // Adjust defaults to account for absent members.
        PipelineStream.PrimitiveTopologyType = D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE;
...
struct CD3DX12_PIPELINE_STATE_STREAM5_PARSE_HELPER : public ID3DX12PipelineParserCallbacks
{
    ...
    CD3DX12_PIPELINE_STATE_STREAM5_PARSE_HELPER() noexcept : SeenDSS(false)
    {
        // Adjust defaults to account for absent members.
        PipelineStream.PrimitiveTopologyType = D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE;
...
//------------------------------------------------------------------------------------------------
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 609)
inline bool operator==(const D3D12_RENDER_PASS_BEGINNING_ACCESS_PRESERVE_LOCAL_PARAMETERS &a,
                       const D3D12_RENDER_PASS_ENDING_ACCESS_PRESERVE_LOCAL_PARAMETERS &b) noexcept
{
    return ((a.AdditionalWidth == b.AdditionalWidth) && (a.AdditionalHeight == b.AdditionalHeight));
}

inline bool operator==(const D3D12_RENDER_PASS_BEGINNING_ACCESS_PRESERVE_LOCAL_PARAMETERS &a,
                       const D3D12_RENDER_PASS_BEGINNING_ACCESS_PRESERVE_LOCAL_PARAMETERS &b) noexcept
{
    return ((a.AdditionalWidth == b.AdditionalWidth) && (a.AdditionalHeight == b.AdditionalHeight));
}

inline bool operator==(const D3D12_RENDER_PASS_ENDING_ACCESS_PRESERVE_LOCAL_PARAMETERS &a,
                       const D3D12_RENDER_PASS_ENDING_ACCESS_PRESERVE_LOCAL_PARAMETERS &b) noexcept
{
    return ((a.AdditionalWidth == b.AdditionalWidth) && (a.AdditionalHeight == b.AdditionalHeight));
}
                       ...
                       const D3D12_RENDER_PASS_BEGINNING_ACCESS &b) noexcept
{
    ...
    case D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_PRESERVE_LOCAL_UAV:
        if (!(a.PreserveLocal == b.PreserveLocal))
            return false;
        break;
#endif
    }
...
class CD3DX12_BARRIER_SUBRESOURCE_RANGE : public D3D12_BARRIER_SUBRESOURCE_RANGE
{
  public:
    ...
    CD3DX12_BARRIER_SUBRESOURCE_RANGE(const D3D12_BARRIER_SUBRESOURCE_RANGE &o)
    noexcept : D3D12_BARRIER_SUBRESOURCE_RANGE(o)
    {
    }
    ...
    CD3DX12_BARRIER_SUBRESOURCE_RANGE(UINT firstMipLevel, UINT numMips, UINT firstArraySlice, UINT numArraySlices,
                                      UINT firstPlane = 0, UINT numPlanes = 1)
    noexcept
        : D3D12_BARRIER_SUBRESOURCE_RANGE{firstMipLevel,  numMips,    firstArraySlice,
...
class CD3DX12_GLOBAL_BARRIER : public D3D12_GLOBAL_BARRIER
{
  public:
    ...
    CD3DX12_GLOBAL_BARRIER(D3D12_BARRIER_SYNC syncBefore, D3D12_BARRIER_SYNC syncAfter,
...
class CD3DX12_BUFFER_BARRIER : public D3D12_BUFFER_BARRIER
{
  public:
    ...
    CD3DX12_BUFFER_BARRIER(D3D12_BARRIER_SYNC syncBefore, D3D12_BARRIER_SYNC syncAfter,
                           D3D12_BARRIER_ACCESS accessBefore, D3D12_BARRIER_ACCESS accessAfter, ID3D12Resource *pRes)
    noexcept
...
class CD3DX12_TEXTURE_BARRIER : public D3D12_TEXTURE_BARRIER
{
  public:
    ...
    CD3DX12_TEXTURE_BARRIER(D3D12_BARRIER_SYNC syncBefore, D3D12_BARRIER_SYNC syncAfter,
                            D3D12_BARRIER_ACCESS accessBefore, D3D12_BARRIER_ACCESS accessAfter,
                            D3D12_BARRIER_LAYOUT layoutBefore, D3D12_BARRIER_LAYOUT layoutAfter, ID3D12Resource *pRes,
                            const D3D12_BARRIER_SUBRESOURCE_RANGE &subresources,
                            D3D12_TEXTURE_BARRIER_FLAGS flag = D3D12_TEXTURE_BARRIER_FLAG_NONE)
    noexcept
        : D3D12_TEXTURE_BARRIER{syncBefore,  syncAfter, accessBefore, accessAfter, layoutBefore,
                                layoutAfter, pRes,      subresources, flag}
    {
    }
};
...
class CD3DX12FeatureSupport
{
  public: // Function declaration
    ...
    // Retreives the status of the object. If an error occurred in the initialization process, the function returns the
    // error code.
    ...
    HRESULT MultisampleQualityLevels(DXGI_FORMAT Format, UINT SampleCount, D3D12_MULTISAMPLE_QUALITY_LEVEL_FLAGS Flags,
                                     UINT &NumQualityLevels) const;
  ...
  private: // Member data
    ...
    std::vector<D3D12_FEATURE_DATA_PROTECTED_RESOURCE_SESSION_TYPE_COUNT>
        m_dProtectedResourceSessionTypeCount;                                         // Cat2 NodeIndex
...
inline CD3DX12FeatureSupport::CD3DX12FeatureSupport() noexcept
    : m_pDevice(nullptr), m_hStatus(E_INVALIDARG), m_dOptions{}, m_eMaxFeatureLevel{}, m_dGPUVASupport{},
      m_dShaderModel{}, m_dOptions1{}, m_dRootSignature{}, m_dOptions2{}, m_dShaderCache{}, m_dCommandQueuePriority{},
      m_dOptions3{}, m_dExistingHeaps{}, m_dOptions4{}, m_dCrossNode{}, m_dOptions5
{
}
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 4)
, m_dDisplayable
...
#endif
, m_dOptions6{}, m_dOptions7
{
}
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 3)
, m_dOptions8{}, m_dOptions9
{
}
#endif
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 4)
, m_dOptions10{}, m_dOptions11
{
}
#endif
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 600)
...
inline HRESULT CD3DX12FeatureSupport::Init(ID3D12Device *pDevice)
{
    ...
    if (FAILED(m_pDevice->CheckFeatureSupport(D3D12_FEATURE_GPU_VIRTUAL_ADDRESS_SUPPORT, &m_dGPUVASupport,
                                              sizeof(m_dGPUVASupport))))
    {
        m_dGPUVASupport = {};
    }
    ...
    if (FAILED(
            m_pDevice->CheckFeatureSupport(D3D12_FEATURE_EXISTING_HEAPS, &m_dExistingHeaps, sizeof(m_dExistingHeaps))))
    {
        m_dExistingHeaps = {};
    }
    ...
    for (UINT NodeIndex = 0; NodeIndex < uNodeCount; NodeIndex++)
    {
        ...
        if (FAILED(m_pDevice->CheckFeatureSupport(D3D12_FEATURE_ARCHITECTURE1, &m_dArchitecture1[NodeIndex],
                                                  sizeof(m_dArchitecture1[NodeIndex]))))
        {
        ...
        if (FAILED(m_pDevice->CheckFeatureSupport(D3D12_FEATURE_SERIALIZATION, &m_dSerialization[NodeIndex],
                                                  sizeof(m_dSerialization[NodeIndex]))))
        {
...
inline HRESULT CD3DX12FeatureSupport::FormatSupport(DXGI_FORMAT Format, D3D12_FORMAT_SUPPORT1 &Support1,
                                                    D3D12_FORMAT_SUPPORT2 &Support2) const
{
    ...
    HRESULT result = m_pDevice->CheckFeatureSupport(D3D12_FEATURE_FORMAT_SUPPORT, &dFormatSupport,
...
inline HRESULT CD3DX12FeatureSupport::MultisampleQualityLevels(DXGI_FORMAT Format, UINT SampleCount,
                                                               ...
                                                               UINT &NumQualityLevels) const
{
    ...
    HRESULT result =
        m_pDevice->CheckFeatureSupport(D3D12_FEATURE_MULTISAMPLE_QUALITY_LEVELS, &dMultisampleQualityLevels,
...
inline HRESULT CD3DX12FeatureSupport::FormatInfo(DXGI_FORMAT Format, UINT8 &PlaneCount) const
{
    ...
    HRESULT result =
        m_pDevice->CheckFeatureSupport(D3D12_FEATURE_FORMAT_INFO, &dFormatInfo, sizeof(D3D12_FEATURE_DATA_FORMAT_INFO));
    if (FAILED(result))
    {
        PlaneCount = 0;
    }
...
inline D3D12_PROTECTED_RESOURCE_SESSION_SUPPORT_FLAGS CD3DX12FeatureSupport::ProtectedResourceSessionSupport(
    UINT NodeIndex) const
{
...
{
    return m_pDevice->CheckFeatureSupport(D3D12_FEATURE_QUERY_META_COMMAND, &dQueryMetaCommand,
                                          sizeof(D3D12_FEATURE_DATA_QUERY_META_COMMAND));
}
...
FEATURE_SUPPORT_GET_NODE_INDEXED_NAME(UINT, m_dProtectedResourceSessionTypeCount, Count,
                                      ProtectedResourceSessionTypeCount);

// 34: Protected Resource Session Types
FEATURE_SUPPORT_GET_NODE_INDEXED_NAME(std::vector<GUID>, m_dProtectedResourceSessionTypes, TypeVec,
...
inline HRESULT CD3DX12FeatureSupport::QueryHighestShaderModel()
{
    ...
    for (size_t i = 0; i < numModelVersions; i++)
    {
        ...
        result = m_pDevice->CheckFeatureSupport(D3D12_FEATURE_SHADER_MODEL, &m_dShaderModel,
...
inline HRESULT CD3DX12FeatureSupport::QueryHighestRootSignatureVersion()
{
    ...
    for (size_t i = 0; i < numRootSignatureVersions; i++)
    {
        ...
        result = m_pDevice->CheckFeatureSupport(D3D12_FEATURE_ROOT_SIGNATURE, &m_dRootSignature,
...
inline HRESULT CD3DX12FeatureSupport::QueryHighestFeatureLevel()
{
    ...
    result = m_pDevice->CheckFeatureSupport(D3D12_FEATURE_FEATURE_LEVELS, &dFeatureLevel,
