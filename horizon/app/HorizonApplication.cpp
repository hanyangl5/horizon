...
void HorizonApplication::Initilize() noexcept
{
	...
	m_render_system = std::make_unique<RenderSystem>(m_window->GetWidth(), m_window->GetHeight(), m_window);
	m_input_system = std::make_unique<InputSystem>(m_window, m_render_system->GetMainCamera());
