...
namespace Horizon
{
	...
	ShaderComplier::ShaderComplier() noexcept
	{
	...
	void ShaderComplier::InitializeShaderCompiler() noexcept
	{
	}
	...
	std::vector<char> ShaderComplier::read_file(const std::string &path) noexcept
	{
