...
struct ShaderResource {
    ...
    //    uint32_t            mtlArgumentBufferType;    // Needed to bind multiple resources under a same descriptor on
    //    Metal.
...
struct PipelineReflection {
    ShaderStageFlags mShaderStages;
