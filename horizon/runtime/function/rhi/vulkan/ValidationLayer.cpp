...
namespace Horizon {
	...
	bool ValidationLayer::checkValidationLayerSupport()
	{
		...
		for (const const auto& layerName : validation_layers) {
			bool layerFound = false;
			// loop all available layers
			for (const const auto& layerProperties : availableLayers) {
	...
	void ValidationLayer::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& debugUtilsMessengerCreateInfo)
	{
