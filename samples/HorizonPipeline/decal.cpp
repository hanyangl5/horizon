//#include "decal.h"
//
//DecalData::DecalData(Backend::RHI *rhi, SceneManager *scene_manager, DeferredData *deferred_data) noexcept {
...
//        deferred_data->gbuffer0->GetTexture()->m_format, deferred_data->gbuffer1->GetTexture()->m_format,
//        deferred_data->gbuffer2->GetTexture()->m_format, deferred_data->gbuffer3->GetTexture()->m_format,
//        deferred_data->gbuffer4->GetTexture()->m_format};
//    graphics_pass_ci.render_target_formats.has_depth = true;
//    graphics_pass_ci.render_target_formats.depth_stencil_format = deferred_data->depth->GetTexture()->m_format;
//
...
//                                           ResourceState::RESOURCE_STATE_SHADER_RESOURCE, sizeof(DecalConstants)});
//}
