...
static ddspp_constexpr unsigned int DDS_HEADER_CAPS2_CUBEMAP_POSITIVEX =
    0x00000600; // DDSCAPS2_CUBEMAP | DDSCAPS2_CUBEMAP_POSITIVEX
static ddspp_constexpr unsigned int DDS_HEADER_CAPS2_CUBEMAP_NEGATIVEX =
    0x00000a00; // DDSCAPS2_CUBEMAP | DDSCAPS2_CUBEMAP_NEGATIVEX
static ddspp_constexpr unsigned int DDS_HEADER_CAPS2_CUBEMAP_POSITIVEY =
    0x00001200; // DDSCAPS2_CUBEMAP | DDSCAPS2_CUBEMAP_POSITIVEY
static ddspp_constexpr unsigned int DDS_HEADER_CAPS2_CUBEMAP_NEGATIVEY =
    0x00002200; // DDSCAPS2_CUBEMAP | DDSCAPS2_CUBEMAP_NEGATIVEY
static ddspp_constexpr unsigned int DDS_HEADER_CAPS2_CUBEMAP_POSITIVEZ =
    0x00004200; // DDSCAPS2_CUBEMAP | DDSCAPS2_CUBEMAP_POSITIVEZ
static ddspp_constexpr unsigned int DDS_HEADER_CAPS2_CUBEMAP_NEGATIVEZ =
...
static ddspp_constexpr unsigned int DXGI_MISC_FLAG_CUBEMAP =
    0x2; // https://docs.microsoft.com/en-us/windows/desktop/api/d3d11/ne-d3d11-d3d11_resource_misc_flag
static ddspp_constexpr unsigned int DDS_MISC_FLAGS2_ALPHA_MODE_MASK = 0x7;

ddspp_constexpr inline unsigned int MakeFourCC(const char *value) {
...
inline ddspp_constexpr bool is_rgba_mask(const PixelFormat &ddspf, unsigned int rmask, unsigned int gmask,
...
inline ddspp_constexpr bool is_rgb_mask(const PixelFormat &ddspf, unsigned int rmask, unsigned int gmask,
                                        unsigned int bmask) {
    return (ddspf.RBitMask == rmask) && (ddspf.GBitMask == gmask) && (ddspf.BBitMask == bmask);
}
} // namespace internal
...
enum Result : unsigned char { Success, Error };
...
inline Result decode_header(unsigned char *sourceData, Descriptor &desc) {
    ...
    const HeaderDXT10 dxt10Header =
        *reinterpret_cast<const HeaderDXT10 *>(sourceData + sizeof(DDS_MAGIC) + sizeof(Header));
...
inline void encode_header(const DXGIFormat format, const unsigned int width, const unsigned int height,
                          const unsigned int depth, const TextureType type, const unsigned int mipCount,
                          const unsigned int arraySize, Header &header, HeaderDXT10 &dxt10Header) {
...
inline ddspp_constexpr unsigned int get_offset(const Descriptor &desc, const unsigned int mip,
