...
from utils import is_input_struct, get_input_struct_var, hsl_assert, get_whitespace, get_array_dims
...
def get_mtl_patch_type(tessellation_layout):
    ...
    hsl_assert(domain in mtl_patch_types, message='Cannot map domain to mtl patch type: ' + domain)
        ...
        if 'RES(' in line:
            ...
            if not is_embedded: # regular resource
                ...
                if 'Sampler' in resType:
                    ...
                    hsl_assert(False, message="Unknown Resource location")
